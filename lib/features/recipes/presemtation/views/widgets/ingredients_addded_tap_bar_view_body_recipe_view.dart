...
import 'package:chief_mate/features/recipes/presemtation/views/widgets/custom_ingrediets_added_tap_bar_view_body_list_view.dart';
...
class IngredientsAdddedTapBarViewBodyRecipeView extends StatelessWidget {
  const IngredientsAdddedTapBarViewBodyRecipeView({super.key});
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          const CustomIngrediebtsAddedTapBarViewBodyListView(),
